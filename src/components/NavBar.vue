<template>
  <nav class="fixed z-30 w-full border-b border-gray-700 bg-gray-800">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          <button
            ...
            class="cursor-pointer rounded p-2 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 text-gray-400 hover:bg-gray-700 dark:hover:text-white dark:focus:bg-gray-700 dark:focus:ring-gray-700 lg:hidden"
          >
            <svg
        ...
        <div class="flex items-center">
          ...
          <div
            class="my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded bg-white text-base shadow-lg dark:divide-gray-600 dark:bg-gray-700"
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      axios
        .get("http://10.252.129.15:1993/api/test/user")
        .then((result) => {
